 ...
 * element; ARGV is an array of pointer to them */
int main(int argc, char*argv[])
{
    ...
    do {
        ...
        case 'o': /* -o or --output */
            /* This option take an argument, the name of the output file. */
        ...
        case '?': /* The user specified and invalid option. */
         ...
         * For demonstration purpose, print them if the verbos option was 
         * specified. */
        if (verbose) {
            int i;
